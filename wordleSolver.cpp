...
void wordlistfunc(); // function to create wordlist
...
void startwordle()
{
    ...
    words.resize(0);
    words = {"crane","slate","soare","trace","serai","arose","tales","cones","hates","audio","adieu"}; // OPENING WORDS FOR GUESS
...
void help()
{
    ...
    cout<<"Note*: If a word is not available in the dictionary enter x to get a new word\n";
...
void wordlistfunc() // This function is used to generate wordlist
{
    wordlist = {
        "aahed",
        "aalii",
